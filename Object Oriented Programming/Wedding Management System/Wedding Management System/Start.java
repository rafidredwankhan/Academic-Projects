		...
		/*try {*/while(true)
		{
			...
			switch(mainInput)
			{
				...
				/*try{*/while(true)
				{
					...
					{
						case 1:          //case 1 is to add an employee
						System.out.print("\nEnter Employee Name : ");
						String name=sc.next();
						...
						case 2:          //case 2 is to remove an employee
						...
						case 3:        //case 3 is to view employees
						...
						case 4:      //case 4 is to create a team consisting 2 members
						System.out.print("\nEnter Team Number : ");
						int tnum=sc.nextInt();
				...
				}/*}catch(Exception e)
			{
				...
				while(true)
				{
					...
					Client c1=new Client(name,phoneNo,email,clientNId);
					cfrw.writeInFile(c1.getName());  //will write in client history
					//cfrw.readFromFile();
					cfrw.writeInFile(c1.getPhoneNo()); //will write in client history
					//cfrw.readFromFile();
					cfrw.writeInFile(c1.getEmail());  //will write in client history
					//cfrw.readFromFile();
					cfrw.writeInFile(c1.getClientNId());  //will write in client history
					//cfrw.readFromFile();
					...
					while(true)
					{
						...
						int photographerCost=50000;  //constant photographer cost
						...
						switch(packageInput)
						{
							case 1:       //will show client details and choosen package
							c1.clientDetails();
							p1.showPackageInfo();
							System.out.println("\tDo you want to add photographer(cost 50,000) ? If you want to add PRESS 1 and If you don't PRESS any key");
							...
							case 2:        //will show client details and choosen package
							c1.clientDetails();
							p2.showPackageInfo();
							System.out.println("\tDo you want to add photographer(cost 50,000) ? If you want to add PRESS 1 and If you don't PRESS any key ");
							...
							case 3:       //will show client details and choosen package
							c1.clientDetails();
							p3.showPackageInfo();
							System.out.println("\tDo you want to add photographer(cost 50,000) ? If you want to add PRESS 1 and If you don't PRESS any key ");
							...
							case 4:           //will show client details and choosen package
							c1.clientDetails();
							p4.showPackageInfo();
							System.out.println("\tDo you want to add photographer(cost 50,000) ? If you want to add PRESS 1 and If don't PRESS any key ");
							...
							case 5:              //will show client details and choosen package
							c1.clientDetails();
							p5.showPackageInfo();
							System.out.println("\tDo you want to add photographer(cost 50,000) ? If you want to add PRESS 1 and If don't PRESS any key ");
